BEGIN TRANSACTION;
--ROLLBACK;
DROP TABLE IF EXISTS member, interest_group, event, event_member, attend_event, department, employee, project, project_employee, timesheet CASCADE;
...
(
	...
	--CONSTRAINT interest_group_fkey FOREIGN KEY (member_number_id) REFERENCES interest_group (group_number)
);
...
(
	...
	CONSTRAINT member_fkey FOREIGN KEY (group_number)REFERENCES member (member_number_id)
);
...
(
	...
	CONSTRAINT event_fkey FOREIGN KEY (group_running_event)REFERENCES interest_group (group_number)
);
...
(
	...
	CONSTRAINT event_number_fkey FOREIGN KEY (event_number)REFERENCES event (event_number)
...
(
    ...
    member_number_id integer NOT NULL,
	CONSTRAINT attend_eventr_pkey PRIMARY KEY (group_number, member_number_id),
	CONSTRAINT attend_event_fkey FOREIGN KEY (group_number)REFERENCES interest_group(group_number),
	CONSTRAINT member_fkey FOREIGN KEY (member_number_id) REFERENCES member(member_number_id)
);
