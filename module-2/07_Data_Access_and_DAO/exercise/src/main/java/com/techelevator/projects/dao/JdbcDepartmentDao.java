...
public class JdbcDepartmentDao implements DepartmentDao {
	...
	public void updateDepartment(Department updatedDepartment) {
		Department department = null;
		String sqlGetDepartment = "UPDATE department SET name = ? WHERE department_id = ?";
		jdbcTemplate.update(sqlGetDepartment, updatedDepartment.getName(), updatedDepartment.getId());
