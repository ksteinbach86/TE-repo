...
public class JdbcParkDaoTests extends BaseDaoTests {
    ...
    public void setup() {
        ...
        testPark = new Park(0, "Park 4", LocalDate.parse("2022-02-24"), 400, true);
    }
    ...
    public void getParksByState_returns_all_parks_for_state() {
        ...
        List<Park> moreParks = sut.getParksByState("CC");
        Assert.assertEquals(1, moreParks.size());
        assertParksMatch(PARK_3, moreParks.get(0));
    }
...
//        sut.deleteCity(4);
//
//        // Test whether the city is no longer
...
//        Assert.assertNull(retrievedCity);
    ...
    public void park_added_to_state_fails_when_id_is_invalid() {
        sut.addParkToState(99, "AA");
    }

    @Test(expected=DataIntegrityViolationException.class)
    public void park_added_to_state_fails_when_state_is_invalid() {
        sut.addParkToState(2, "XX");
    }
