...
public class HotelService {
    ...
    public Reservation addReservation(Reservation newReservation) {
        // Create the reservation we want to return
        ...
        try {
            returnedReservation = restTemplate.postForObject(API_BASE_URL + "reservations", entity,
                                                             Reservation.class);
        }
        ...
        // Return either null (on error) or the reservation returned in response
