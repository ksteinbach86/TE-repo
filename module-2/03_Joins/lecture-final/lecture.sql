...
-- SELECT city_name, state_name
-- FROM city
-- JOIN state ON city.city_name = state.state_name;
...
-- Modify the previous query to sort the results by the number of cities in descending order (with more than 5).
