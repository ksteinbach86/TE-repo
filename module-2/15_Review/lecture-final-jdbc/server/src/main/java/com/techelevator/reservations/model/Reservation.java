...
public class Reservation {
    ...
    @Size(min=10, max=10, message="checkinDate must be formatted as mm/dd/yyyy or yyyy-mm-dd")
    private String checkinDate;
    @NotBlank(message = "The field 'checkoutDate required.")
    @Size(min=10, max=10, message="checkoutDate must be formatted as mm/dd/yyyy or yyyy-mm-dd")
