...
UPDATE state
SET state_nickname = 'The Golden State', population = 2000000, capital = (SELECT city_id FROM city WHERE city_name = 'Sacramento' AND state_abbreviation = 'CA')
WHERE state_abbreviation = 'CA';
...
DELETE
FROM park
WHERE state_abbreviation = 'CA' AND park_id (SELECT park_id FROM park WHERE park_name = 'Disneyland');
...
INSERT INTO city (city_name, state abbreviation)
...
WHERE state_abbreviation = 'Florida';
