...
SELECT city_name, state_abbreviation, area
FROM city
WHERE area < 25;
...
SELECT park_name, has_camping, date_established, (area / 2) AS half_area
FROM park
WHERE has_camping AND date_established < '1980-1-1';

SELECT state_name, census_region
FROM state
WHERE census_region NOT LIKE '%est';
