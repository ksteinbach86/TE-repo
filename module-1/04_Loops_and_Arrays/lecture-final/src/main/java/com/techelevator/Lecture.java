...
public class Lecture {
    ...
    */
    //int j = 3;
    //int myresult = returnVariableFromBlock(j);
    ...
    */
//    public String[] capitalizeNames(String[] array) {
//        if (names == null) {
//            return null;
//        }
//        if (names.length == 0)
...
//    }
    ...
    public boolean returnCountCorrectTimes() {
        ...
        int counter = 0;
//        String[] namesOfContinents;
//
//        String[] capitalizedContinents = capitizeNames(namesOfContinents);
    ...
    */
    ...
    public String[] addPrefixToNames(String[] array, String prefix) {
        int changes = 0;

        // check things are valid

        // Loop through array, adding prefix
