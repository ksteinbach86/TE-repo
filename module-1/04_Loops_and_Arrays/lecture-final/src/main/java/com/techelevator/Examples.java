...
//		System.out.println();
		...
		System.out.println("****************");
		System.out.println("**** ARRAYS with FOR loops ****");
		System.out.println("****************");
		System.out.println();
		...
		System.out.println("Element has value even before being assigned " + myArrayOf3[2]);
		myArrayOf3[0] = 5;
		myArrayOf3[1] = 2;
		myArrayOf3[2] = 3;
		...
		//boolean[] myBooleans = new boolean[] {true, true, true, false};
		boolean[] myBooleans = {true, true, true, false};
		//boolean[] myBooleans = new boolean[4];

		String[] strings = new String[5];
		String[] strings2 = new String[] {"a", "b", "c", "d", "e"};
		String[] strings3 = {"a", "b", "c", "d", "e"};


		System.out.println(myBooleans[0]);

//		myNewArray = myMethod(array);
