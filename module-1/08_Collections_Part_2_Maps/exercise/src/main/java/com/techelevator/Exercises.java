...
public class Exercises {
	...
	public String animalGroupName(String animalName) {
		...
		Map<String, Double> discountPrice = new HashMap<>();
		...
		if (itemNumber == null) {
			...
			if (discountPrice.containsKey(itemNumber.toUpperCase())) {
				return discountPrice.get(itemNumber.toUpperCase());
			}
		return 0.0;
...
//			}
		...
		public Map<String, String> beginningAndEnding (String[]words){
			...
			Map<String, String> lastCharValue = new HashMap<>();

			for (String strings : words) {
				lastCharValue.put(strings.substring(0, 1), strings.substring(strings.length() - 1));
		...
		public Map<String, Integer> wordCount (String[]words){
			...
			for (String number : words) {
				if(numberOfTimes.containsKey(number)) {
					int numberCount = numberOfTimes.get(number);
					numberCount++;
					numberOfTimes.put(number, numberCount);
				} else {
					numberOfTimes.put(number, 1);
				}
			}
